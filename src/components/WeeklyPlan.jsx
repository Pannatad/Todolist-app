...
import { CalendarDays, CheckCircle2, ChevronLeft, ChevronRight, Clock, Layers, ListChecks, RotateCcw } from 'lucide-react';
...
const WeeklyPlan = ({ tasks = [], scheduleItems = [], onCompleteTask }) => {
