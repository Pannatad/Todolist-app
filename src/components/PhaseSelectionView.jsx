        ...
        <div className="h-full flex flex-col relative overflow-hidden bg-gradient-to-br from-slate-950 via-purple-950 to-indigo-950 rounded-2xl">
            ...
            <div className="relative z-10 flex items-center justify-between p-6 border-b border-white/10">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-white/60">Select a phase to view tasks</p>
                    </div>
                </div>
                <button
            ...
            <div className="relative z-10 flex-1 p-8 overflow-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                    {sortedPhases.map((phase, index) => {
                        ...
                        return (
                            <div
                                key={phase.id}
                                className={`
                                    relative p-6 rounded-2xl border-2 backdrop-blur-md
                                    bg-gradient-to-br ${getPhaseColor(phase.color)}
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="absolute top-4 right-4 p-2 rounded-full bg-white/10 hover:bg-white/20 text-white/60 hover:text-white opacity-0 group-hover:opacity-100 transition-all z-10"
                                >
                                ...
                                {phaseMenuOpen === phase.id && (
                                    <div
                                        className="absolute top-12 right-4 bg-slate-900 border border-white/10 rounded-lg shadow-xl z-20 min-w-[140px] overflow-hidden"
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            className="w-full px-4 py-2.5 text-left text-sm hover:bg-red-500/20 flex items-center gap-2 text-red-400"
                                        >
                                ...
                                {isComplete && (
                                    <div className="absolute top-4 right-4 p-2 bg-emerald-500/30 rounded-full border border-emerald-400/50">
                    ...
                    <button
                        onClick={() => setShowAddModal(true)}
                        className="p-6 rounded-2xl border-2 border-dashed border-white/20 hover:border-purple-400/50 bg-white/5 hover:bg-white/10 transition-all duration-300 flex flex-col items-center justify-center gap-3 min-h-[200px]"
                    >
                        <div className="p-3 bg-white/10 rounded-full">
                            <Plus className="w-6 h-6 text-white/60" />
                        </div>
                        <span className="text-white/60 font-medium">Add New Phase</span>
                    </button>
                </div>
            </div>
                        ...
                        <div className="p-6">
                            ...
                            <form onSubmit={handleAddPhase}>
                                <div className="space-y-4 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-purple-500/50 text-white outline-none"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <button
                                        type="submit"
                                        className="flex-1 px-4 py-2 rounded-lg bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-medium hover:from-purple-600 hover:to-indigo-600 transition-colors"
                                    >
                                        Add Phase
                                    </button>
                                </div>
