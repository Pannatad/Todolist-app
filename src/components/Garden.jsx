        ...
        <div className="w-full flex flex-col lg:flex-row gap-16">
            ...
            <div className="flex-1">
                <div className="mb-12">
                    ...
                    <div className="relative flex justify-center overflow-visible py-8">
                        <motion.div
                            layout
                            className="grid grid-cols-3 sm:grid-cols-4 gap-10"
                        >
                            ...
                            {[...Array(emptySlots)].map((_, i) => (
                                <div
                                    key={`empty-${i}`}
                                    className="w-32 h-32 rounded-2xl bg-white/50 dark:bg-void-900/50 border-2 border-dashed border-sage-300 dark:border-white/10 flex items-center justify-center transition-colors hover:bg-white/80 dark:hover:bg-void-800 shadow-sm"
                                >
                            ...
                            <div
                                onClick={onBuyPlot}
                                className={`w-32 h-32 rounded-2xl bg-white/50 dark:bg-void-900/50 border-2 border-dashed border-sage-300 dark:border-white/10 flex flex-col items-center justify-center cursor-pointer hover:bg-white/80 dark:hover:bg-void-800 transition-colors group shadow-sm ${coins < 50 ? 'opacity-50' : ''}`}
                            >
                ...
                {completedTasks.length > 0 && (
                    <div className="border-t border-sage-200 dark:border-white/10 pt-8">
                        <h2 className="text-2xl font-serif text-sage-400 dark:text-bone-200/50 mb-6 pl-2">Banished Souls</h2>
            ...
            <div className="w-full lg:w-80 shrink-0">
                <div className="sticky top-8">
                    <h3 className="text-xl font-serif font-bold text-sage-600 dark:text-magma-500 mb-4 flex items-center gap-2">
                        <span className="text-2xl">📅</span> Today's Schedule
                    </h3>

                    <div className="space-y-3">
                        {todayTasks.length === 0 ? (
                            <div className="p-6 text-center border-2 border-dashed border-sage-200 dark:border-white/10 rounded-xl text-sage-400 dark:text-bone-200/50 italic">
