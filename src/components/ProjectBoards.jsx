                        ...
                        <div className="flex justify-between items-start mb-3">
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className="p-1 rounded-full hover:bg-sage-100 dark:hover:bg-void-700 text-sage-500 dark:text-bone-400 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity"
                                >
